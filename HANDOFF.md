...
Phases 0–5c are **complete**. **Next: Phase 5d — Engagement & social** (real Save/Bookmark, `@mention` notifications, bell icon in Navbar, karma counters on `/u/{username}`, nightly karma cron). Full details in `PLAN.md §5d`.
