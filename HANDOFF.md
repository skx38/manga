...
Phases 0–5d are **complete**. **Next: Phase 5e — Moderation tools** (Report model, `ComicMod` join table, mod queue at `/c/{slug}/mod`, lock/pin/remove actions in PostCard, banned-words auto-flag). Full details in `PLAN.md §5e`.
