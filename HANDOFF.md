...
Phases 0–5e are **complete**. The full community/Reddit overhaul is shipped. Remaining roadmap items are the original Phase 4c/4d (Mihon import + Wait-to-Read) — see PLAN.md.
